      ...
      <v-col cols="12" sm="12" md="12">
        <section class="main-section mainContainer">
          ...
          <p class="gaslo_main gaslo_main__first">
            ...
            <span class="font-red">блог</span> для твого відпочинку
          </p>
          ...
          <p class="gaslo_main gaslo_main__three">
            Багато зареєстрованих
            <span class="font-red">блогерів</span> на нашому проекті
          </p>
...
.black__btn:after {
  ...
  transform: scale(0);
  border-radius: 50%;
  // background: #3e3e3e; // чорний колір
  background: #33bb60;
}
